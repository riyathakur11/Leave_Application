                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <i style="color:#4154f1;" onClick="editHoliday('{{ $data->id }}')"
                                        ...
                                        href="javascript:void(0)" class="fa fa-edit fa-fw pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Holiday"></i>

                                    <i style="color:#4154f1;" onClick="deleteHoliday('{{ $data->id }}')"

                                        href="javascript:void(0)" class="fa fa-trash fa-fw pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete Holiday"></i>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="addHolidayLabel">Add 55 Holiday</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="date" class="form-control" name="edit_to" id="edit_to" min="{{ date('Y-m-d') }}">
